...
storeFrontLinkIcon = document.querySelector(".title .img-wrapper .link-img");

function linkIconAppear() {
  storeFrontLinkIcon.style.display = "block";
}

function linkIconDisappear() {
  storeFrontLinkIcon.style.display = "none";
}
